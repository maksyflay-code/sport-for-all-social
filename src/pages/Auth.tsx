            ...
            <>
              ...
              <div className="relative my-4">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-[#1a1a2e] px-3 text-white/30">ou</span>
                </div>
              </div>
              ...
              <Button
                ...
                disabled={loading}
                variant="outline"
                className="w-full h-11 rounded-xl border-white/10 bg-white/5 text-white hover:bg-white/10 font-semibold text-sm gap-2"
              >
